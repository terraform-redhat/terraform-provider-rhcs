...
- `cluster_routes_hostname` (String, Deprecated) Components route hostname for oauth, console, download.
- `cluster_routes_tls_secret_ref` (String, Deprecated) Components route TLS secret reference for oauth, console, download.
