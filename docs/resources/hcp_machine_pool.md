...
- `capacity_reservation_id` (String) The ID of the AWS Capacity Reservation to use for the node pool. After the creation of the resource, it is not possible to update the attribute value.
