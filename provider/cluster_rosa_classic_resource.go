...
func (t *ClusterRosaClassicResourceType) GetSchema(ctx context.Context) (result tfsdk.Schema,
	...
	result = tfsdk.Schema{
		...
		Attributes:  rosaClassicResourceAttributes(),
	}
	return
}

func rosaClassicResourceAttributes() map[string]tfsdk.Attribute {
	attributes := commonAttributesForClusterResources()
	attributes["external_id"] = tfsdk.Attribute{
		Description: "Unique external identifier of the cluster.",
		Type:        types.StringType,
		Computed:    true,
	}
	attributes["sts"] = tfsdk.Attribute{
	...
	attributes["etcd_encryption"] = tfsdk.Attribute{
		Description: "Encrypt etcd data.",
		Type:        types.BoolType,
		Optional:    true,
		Computed:    true,
	}
	attributes["autoscaling_enabled"] = tfsdk.Attribute{
		Description: "Enables autoscaling.",
		Type:        types.BoolType,
		Optional:    true,
	}
	attributes["min_replicas"] = tfsdk.Attribute{
		Description: "Min replicas.",
		Type:        types.Int64Type,
		Optional:    true,
	}
	attributes["max_replicas"] = tfsdk.Attribute{
