---
page_title: "Upgrade ROSA Classic Openshift Cluster"
subcategory: ""
description: |-
  Instructions on how to upgrade ROSA Classic Openshift cluster created via the terraform provider.
---

# Updating or upgrading your ROSA Classic cluster
...
A Classic cluster will upgrade both control plane and machine pools alongside each other based on the version chosen.
